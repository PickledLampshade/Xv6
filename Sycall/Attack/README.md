...
I found that this data array does occur at 0x1010 which is awful, that means we are on the second page if I am correct and our attack program ends on the 4th page or the 5th? 
...
Anyway I was able to find this initial solution by just printing a page and then narrowing it down from there.

I think I gave an illusion of understanding, I understand virtual addresses but i have no clue how going 16 bytes beyond attack in memory gets us to wherever data lives, I am sorry for lying.
